...
import com.mini.orderapp.service.OrdersService;
...
/**
 * REST controller for managing {@link com.mini.orderapp.domain.Orders}.
 */
@RestController
...
public class OrdersResource {
    ...
    public ResponseEntity<OrdersDTO> createOrders(@Valid @RequestBody OrdersDTO ordersDTO) throws URISyntaxException {
        ...
        return ResponseEntity.created(new URI("/api/orders/" + ordersDTO.getId()))
            .headers(HeaderUtil.createEntityCreationAlert(applicationName, false, ENTITY_NAME, ordersDTO.getId().toString()))
            .body(ordersDTO);
    }
